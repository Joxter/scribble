 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Tw;function a5(){if(Tw)return Fh;Tw=1;var e=hl();function t(g,b){return g===b&&(g!==0||1/g===1/b)||g!==g&&b!==b}var r=typeof Object.is=="function"?Object.is:t,i=e.useState,s=e.useEffect,l=e.useLayoutEffect,u=e.useDebugValue;function d(g,b){var w=b(),S=i({inst:{value:w,getSnapshot:b}}),T=S[0].inst,E=S[1];return l(function(){T.value=w,T.getSnapshot=b,h(T)&&E({inst:T})},[g,w,b]),s(function(){return h(T)&&E({inst:T}),g(function(){h(T)&&E({inst:T})})},[g]),u(w),w}function h(g){var b=g.getSnapshot;g=g.value;try{var w=b();return!r(g,w)}catch{return!0}}function p(g,b){return b()}var y=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?p:d;return Fh.useSyncExternalStore=e.useSyncExternalStore!==void 0?e.useSyncExternalStore:y,Fh}var kw;function Ix(){return kw||(kw=1,Xh.exports=a5()),Xh.exports}var qx=Ix();const i5=hm(qx),o5=Vk.useInsertionEffect,s5=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",l5=s5?ce.useLayoutEffect:ce.useEffect,c5=o5||l5,Bx=e=>{const t=ce.useRef([e,(...r)=>t[0](...r)]).current;return c5(()=>{t[0]=e}),t[1]},u5="popstate",Ym="pushState",Pm="replaceState",d5="hashchange",Ew=[u5,Ym,Pm,d5],f5=e=>{for(const t of Ew)addEventListener(t,e);return()=>{for(const t of Ew)removeEventListener(t,e)}},Yx=(e,t)=>qx.useSyncExternalStore(f5,e,t),h5=()=>location.search,p5=({ssrSearch:e=""}={})=>Yx(h5,()=>e),Cw=()=>location.pathname,m5=({ssrPath:e}={})=>Yx(Cw,e?()=>e:Cw),g5=(e,{replace:t=!1,state:r=null}={})=>history[t?Pm:Ym](r,"",e),v5=(e={})=>[m5(e),g5],Mw=Symbol.for("wouter_v3");if(typeof history<"u"&&typeof window[Mw]>"u"){for(const e of[Ym,Pm]){const t=history[e];history[e]=function(){const r=t.apply(this,arguments),i=new Event(e);return i.arguments=arguments,dispatchEvent(i),r}}Object.defineProperty(window,Mw,{value:!0})}const y5=(e,t)=>t.toLowerCase().indexOf(e.toLowerCase())?"~"+t:t.slice(e.length)||"/",Px=(e="")=>e==="/"?"":e,b5=(e,t)=>e[0]==="~"?e.slice(1):Px(t)+e,w5=(e="",t)=>y5(Nw(Px(e)),Nw(t)),Nw=e=>{try{return decodeURI(e)}catch{return e}},Xx={hook:v5,searchHook:p5,parser:r5,base:"",ssrPath:void 0,ssrSearch:void 0,ssrContext:void 0,hrefs:e=>e},Fx=ce.createContext(Xx),ml=()=>ce.useContext(Fx),Gx={},Vx=ce.createContext(Gx),x5=()=>ce.useContext(Vx),Fu=e=>{const[t,r]=e.hook(e);return[w5(e.base,t),Bx((i,s)=>r(b5(i,e.base),s))]},Xm=()=>Fu(ml()),Qx=(e,t,r,i)=>{const{pattern:s,keys:l}=t instanceof RegExp?{keys:!1,pattern:t}:e(t||"*",i),u=s.exec(r)||[],[d,...h]=u;return d!==void 0?[!0,(()=>{const p=l!==!1?Object.fromEntries(l.map((g,b)=>[g,h[b]])):u.groups;let y={...h};return p&&Object.assign(y,p),y})(),...i?[d]:[]]:[!1,null]},_5=({children:e,...t})=>{var y,g;const r=ml(),i=t.hook?Xx:r;let s=i;const[l,u]=((y=t.ssrPath)==null?void 0:y.split("?"))??[];u&&(t.ssrSearch=u,t.ssrPath=l),t.hrefs=t.hrefs??((g=t.hook)==null?void 0:g.hrefs);let d=ce.useRef({}),h=d.current,p=h;for(let b in i){const w=b==="base"?i[b]+(t[b]||""):t[b]||i[b];h===p&&w!==p[b]&&(d.current=p={...p}),p[b]=w,(w!==i[b]||w!==s[b])&&(s=p)}return ce.createElement(Fx.Provider,{value:s,children:e})},Ow=({children:e,component:t},r)=>t?ce.createElement(t,{params:r}):typeof e=="function"?e(r):e,S5=e=>{let t=ce.useRef(Gx);const r=t.current;return t.current=Object.keys(e).length!==Object.keys(r).length||Object.entries(e).some(([i,s])=>s!==r[i])?e:r},ao=({path:e,nest:t,match:r,...i})=>{const s=ml(),[l]=Fu(s),[u,d,h]=r??Qx(s.parser,e,l,t),p=S5({...x5(),...d});if(!u)return null;const y=h?ce.createElement(_5,{base:h},Ow(i,p)):Ow(i,p);return ce.createElement(Vx.Provider,{value:p,children:y})},io=ce.forwardRef((e,t)=>{const r=ml(),[i,s]=Fu(r),{to:l="",href:u=l,onClick:d,asChild:h,children:p,className:y,replace:g,state:b,...w}=e,S=Bx(E=>{E.ctrlKey||E.metaKey||E.altKey||E.shiftKey||E.button!==0||(d==null||d(E),E.defaultPrevented||(E.preventDefault(),s(u,e)))}),T=r.hrefs(u[0]==="~"?u.slice(1):r.base+u,r);return h&&ce.isValidElement(p)?ce.cloneElement(p,{onClick:S,href:T}):ce.createElement("a",{...w,onClick:S,href:T,className:y!=null&&y.call?y(i===u):y,children:p,ref:t})}),Wx=e=>Array.isArray(e)?e.flatMap(t=>Wx(t&&t.type===ce.Fragment?t.props.children:t)):[e],T5=({children:e,location:t})=>{const r=ml(),[i]=Fu(r);for(const s of Wx(e)){let l=0;if(ce.isValidElement(s)&&(l=Qx(r.parser,s.props.path,t||i,s.props.nest))[0])return ce.cloneElement(s,{match:l})}return null};function Gu(e,t){for(const r in e)t(e[r],r)}function vn(e,t){e.forEach(t)}function Tt(e,t,r){if(!e)throw Error(`${r?r+": ":""}${t}`)}function $r({node:e=[],from:t,source:r,parent:i=t||r,to:s,target:l,child:u=s||l,scope:d={},meta:h={},family:p={type:"regular"},regional:y}={}){const g=Ls(i),b=Ls(p.links),w=Ls(p.owners),S=[];vn(e,E=>E&&zn(S,E));const T={id:U5(),seq:S,next:Ls(u),meta:h,scope:d,family:{triggers:g.length,type:p.type||"crosslink",links:b,owners:w}};return vn(b,E=>zn(Vu(E),T)),vn(w,E=>zn(Qu(E),T)),vn(g,E=>zn(E.next,T)),T}function Zx(e,t,r){let i,s=Dr,l=null,u=it;if(e.target&&(t=e.params,r=e.defer,i=e.meta,s="page"in e?e.page:s,e.stack&&(l=e.stack),u=Gc(e)||u,e=e.target),u&&it&&u!==it&&(it=null),Array.isArray(e))for(let S=0;S<e.length;S++)Xa("pure",s,bn(e[S]),l,t[S],u,i);else Xa("pure",s,bn(e),l,t,u,i);if(r&&!Qc)return;const d={isRoot:Qc,currentPage:Dr,scope:it,isWatch:Wh,isPure:du};let h,p,y,g,b,w;Qc=0;e:for(;g=Y5();){const{idx:S,stack:T,type:E}=g;y=T.node,Dr=b=T.page,it=Gc(T),b?w=b.reg:it&&(w=it.reg);const _=!!b,C=!!it,O={fail:0,scope:y.scope};h=p=0;for(let L=S;L<y.seq.length&&!h;L++){const j=y.seq[L];if(j.order){const{priority:X,barrierID:G}=j.order,ee=G?b?`${b.fullID}_${G}`:G:0;if(L!==S||E!==X){G?Qh.has(ee)||(Qh.add(ee),Bp(L,T,X,G)):Bp(L,T,X,0);continue e}G&&Qh.delete(ee)}switch(j.type){case"mov":{const G=j.data;let ee;switch(G.from){case"stack":ee=cu(T);break;case"a":case"b":ee=T[G.from];break;case"value":ee=G.store;break;case"store":if(w&&!w[G.store.id])if(_){const ne=o2(b,G.store.id);T.page=b=ne,ne?w=ne.reg:C?(xo(it,G.store,0,1,G.softRead),w=it.reg):w=void 0}else C&&xo(it,G.store,0,1,G.softRead);ee=Xs(w&&w[G.store.id]||G.store)}switch(G.to){case"stack":T.value=ee;break;case"a":case"b":T[G.to]=ee;break;case"store":P5(b,it,G.target,0).current=ee}break}case"compute":const X=j.data;if(X.fn){Wh=y.meta.op==="watch",du=X.pure;const G=X.safe?(0,X.fn)(cu(T),O.scope,T):F5(O,X.fn,T);X.filter?p=!G:T.value=G,Wh=d.isWatch,du=d.isPure}}h=O.fail||p}if(!h){const L=cu(T),j=Gc(T);if(vn(y.next,X=>{Xa("child",b,X,T,L,j)}),j){y.meta.needFxCounter&&Xa("child",b,j.fxCount,T,L,j),y.meta.storeChange&&Xa("child",b,j.storeChange,T,L,j),y.meta.warnSerialize&&Xa("child",b,j.warnSerializeNode,T,L,j);const X=j.additionalLinks[y.id];X&&vn(X,G=>{Xa("child",b,G,T,L,j)})}}}Qc=d.isRoot,Dr=d.currentPage,it=Gc(d)}function k5(e,t="combine"){let r=t+"(",i="",s=0;return Gu(e,l=>{s<25&&(l!=null&&(r+=i,r+=Sa(l)?Kx(l).fullName:l.toString()),s+=1,i=", ")}),r+")"}function E5(e,t){let r,i;const s=e;if(t){const l=Kx(t);e.length===0?(r=l.path,i=l.fullName):(r=l.path.concat([e]),i=l.fullName.length===0?e:l.fullName+"/"+e)}else r=e.length===0?[]:[e],i=e;return{shortName:s,fullName:i,path:r}}function di(e,t){if(!t||!t.name&&!t.named&&!t.loc)return e;let r=`[${e}]`;const i=t.named||t.name;i&&(r+=` unit '${i}'`);const s=t.loc;return!i&&s&&(r+=` (${s.file}:${s.line}:${s.column})`),r}function Fm(e,t){const r=t?e:e[0];r2(r);let i=r.or;const s=r.and;if(s){const l=s[0];if(ur(l)&&"and"in l){const u=Fm(s,t);e=u[0],i={...i,...u[1]}}else e=s}return[e,i]}function Hp(e){const t=()=>e();return t.unsubscribe=()=>e(),t}function Vn(e,...t){}function Ge(e,t){const r=sl({or:t,and:typeof e=="string"?{name:e}:e}),i=di("event",r),s=(d,...h)=>(Tt(!ya(s,"derived"),"call of derived event is not supported, use createEvent instead",i),Tt(!du,"unit call from pure function is not supported, use operators like sample instead",i),Dr?((p,y,g,b)=>{const w=Dr;jw(null);const T=p.create(g,b);return jw(w),T})(s,l,d,h):s.create(d,h)),l=$5(),u=Object.assign(s,{graphite:$r({meta:c2(r.actualOp||"event",s,r,Zu(Ge)),regional:1}),create:d=>(Zx({target:s,params:d,scope:it}),d),watch:d=>s2(s,d),map:d=>Zh(s,yo,d,[zr()]),filter:d=>Zh(s,"filter",d.fn?d:d.fn,[zr(Wu,1)]),filterMap:d=>Zh(s,"filterMap",d,[zr(),bo(h=>!Dn(h),1)]),prepend(d){Tt(s.targetable,".prepend of derived event is not supported, call source event instead",i);const h=Ge("* → "+s.shortName,{parent:al(s)});return Vn("eventPrepend",bn(h)),ii(h,s,[zr()],"prepend",d),V5(s,h),h}});return r!=null&&r.domain&&r.domain.hooks.event(u),Rr(u,"id",u.graphite.id),n2(u.graphite),u}function Aw(e,t,r,i,s){return Ip(r,`${s} ${t}`,"first argument"),Tt(Ir(i),"second argument should be a function",s),il(!ya(e,"derived"),`${t} in derived store`,`${t} in store created via createStore`,s),vn(Array.isArray(r)?r:[r],l=>{e.off(l),u2(l,e,"on",q5,i)}),e}function At(e,t){const r=sl(t),i=wo(e),s=di("store",r),l=Ge({named:"updates",derived:1});Vn("storeBase",i);const u=i.id,d="skipVoid"in r,h=d&&!r.skipVoid;il(!(d&&r.skipVoid),"{skipVoid: true}","updateFilter",s);const p={updates:l,defaultState:e,stateRef:i,getState(){let _,C=i;if(Dr){let O=Dr;for(;O&&!O.reg[u];)O=al(O);O&&(_=O)}return!_&&it&&(xo(it,i,1),_=it),_&&(C=_.reg[u]),Xs(C)},setState:_=>Zx({target:p,params:_,defer:1,scope:it}),reset:(..._)=>(Tt(p.targetable,".reset of derived store is not supported",s),vn(_,C=>Aw(p,".reset",C,()=>p.defaultState,s)),p),on:(_,C)=>(Tt(p.targetable,".on of derived store is not supported",s),Aw(p,".on",_,C,s)),off(_){const C=bn(_).id,O=bn(p).family.links.find(L=>L.meta.onTrigger===C);return O&&zu(O),p},map(_,C){let O,L;ur(_)&&(O=_,_=_.fn);const j=p.getState(),X=Dn(j);(!X||X&&h)&&(L=_(j));const G=At(L,{name:`${p.shortName} → *`,derived:1,...C,and:O}),ee=u2(p,G,yo,Wu,_);return qp(sr(G),{type:yo,fn:_,from:i}),sr(G).noInit=1,Vn("storeMap",i,ee),G},watch(_,C){if(il(!C,"watch second argument","sample",s),!C||!Sa(_)){const O=s2(p,_);return Vn("storeWatch",i,_)||_(p.getState()),O}return Tt(Ir(C),"second argument should be a function",s),_.watch(O=>C(p.getState(),O))}},y=c2("store",p,r,Zu(At)),g=p.defaultConfig.updateFilter;p.graphite=$r({scope:{state:i,fn:g},node:[bo((_,C,O)=>(O.scope&&!O.scope.reg[i.id]&&(O.b=1),_)),Ja(i),bo((_,C,{a:O,b:L})=>{const j=Dn(_);return j&&!d&&D5(`${s}: ${hu}`,ya(p,"unitTrace")),(j&&h||!j)&&(_!==O||L)},1),g&&zr(a2,1),Rn({from:"stack",target:i})],child:l,meta:{...y,defaultState:e,stateRef:i},regional:1}),Rr(p,"id",p.graphite.id),Rr(p,"rootStateRefId",u);const b=ya(p,"serialize"),w=ya(p,"derived"),S=b==="ignore",T=ya(p,"sid");T&&(Rr(p,"storeChange",1),i.sid=T),T||S||w||Rr(p,"warnSerialize",1);const E=Dn(e);return Tt(w||!E||E&&h,hu,s),w&&E&&!d&&console.error(`${s}: ${hu}`),Ru(p,[l]),r!=null&&r.domain&&r.domain.hooks.store(p),w||(p.reinit=Ge({named:"reinit"}),p.reset(p.reinit)),i.meta=p.graphite.meta,n2(p.graphite),p}function ai(...e){let t,r,i;[e,i]=Fm(e);const s=di("combine",i),l=e[e.length-1],u=e.length>1&&!Un(l)&&ur(l),d=u&&l,h=u?e[e.length-2]:l;let p,y,g;if(Ir(h)?(r=e.slice(0,u?-2:-1),t=h):r=e,r.length===1){const b=r[0];Un(b)||(p=b,y=1)}if(!y&&(p=r,t)){g=1;const b=t;t=w=>b(...w)}return Tt(ur(p),`${s}: shape should be an object`),Q5(Array.isArray(p),!g,p,Zu(ai),i,t,d)}function C5(e,t){let r=0;return vn(W5,i=>{i in e&&(Tt(e[i]!=null,d2(t,i)),r=1)}),r}function Co(...e){let t,r,i,s,[[l,u,d],h]=Fm(e),p=1;const y=di("sample",h);return Dn(u)&&ur(l)&&C5(l,y)&&(u=l.clock,d=l.fn,"batch"in l?p=l.batch:(il(!("greedy"in l),"greedy in sample","batch",y),p=!l.greedy),s=l.filter,t=l.target,r=l.name,i=l.sid,l=l.source),Z5("sample",u,l,s,t,d,r,h,p,1,0,i)}function Mo(e,t,r){const i=di("restore",r);if(Tt(!Un(e),"restore($store) is not supported",i),Jx(e)||Au(e)){const l=al(e),u=At(t,{parent:l,name:e.shortName,and:r});return ii(Au(e)?e.doneData:e,u),l&&l.hooks.store(u),u}const s=Array.isArray(e)?[]:{};return Gu(e,(l,u)=>s[u]=Un(l)?l:At(l,{name:u})),s}function M5(e,{scope:t,safe:r}={}){Tt(t||it||r,"scopeBind: scope not found");const i=t||it;return(...s)=>{function l(){Dw(h)}let u,d=0;const h=it;Dw(i);try{u=e(...s)}catch(p){u=p,d=1}if(l(),d)throw u;return u instanceof Promise&&u.then(l,l),u}}function N5({unit:e,fn:t,scope:r,batch:i}){const s=[uu.run({fn:u=>t(u)})];s.unshift(uu.compute({priority:"sampler",batch:1})),Un(e)&&s.unshift(uu.mov({store:e.stateRef,to:"stack"}));const l=Array.isArray(e)?e:[e];if(r){const u=[],d=r.additionalLinks;return l.forEach(h=>{const p=d[h.graphite.id]||[];d[h.graphite.id]=p;const y=$r({node:O5(s,h),meta:{watchOp:h.kind}});p.push(y),u.push(()=>{const g=p.indexOf(y);g!==-1&&p.splice(g,1),zu(y)})}),Hp(()=>{u.forEach(h=>h())})}{const u=$r({node:s,parent:l,family:{owners:l}});return Hp(()=>{zu(u)})}}function O5(e,t){return Un(t)?[uu.mov({store:t.stateRef,to:"stack"}),...e]:e}const A5=typeof Symbol<"u"&&Symbol.observable||"@@observable",yo="map",bn=e=>e.graphite||e,Vu=e=>e.family.owners,Qu=e=>e.family.links,sr=e=>e.stateRef,cu=e=>e.value,al=e=>e.parent,Gc=e=>e.scope,ya=(e,t)=>bn(e).meta[t],Rr=(e,t,r)=>bn(e).meta[t]=r,Kx=e=>e.compositeName,Sa=e=>(Ir(e)||ur(e))&&"kind"in e,gl=e=>t=>Sa(t)&&t.kind===e,Un=gl("store"),Jx=gl("event"),Au=gl("effect"),R5=e=>Sa(e)&&!!e.targetable,e2=gl("domain"),z5=gl("scope");var Vc={__proto__:null,unit:Sa,store:Un,event:Jx,effect:Au,targetable:R5,domain:e2,scope:z5,attached:e=>Au(e)&&ya(e,"attached")==1};const Gh=(e,t)=>e.includes(t),Vh=(e,t)=>{const r=e.indexOf(t);r!==-1&&e.splice(r,1)},zn=(e,t)=>e.push(t),il=(e,t,r,i)=>!e&&console.error(`${i?i+": ":""}${t} is deprecated${r?`, use ${r} instead`:""}`),D5=(e,t)=>{const r=Error(e);r.stack=t,console.error(r)},Gm=()=>{let e=0;return()=>""+ ++e},j5=Gm(),t2=Gm(),U5=Gm();let L5=null;const n2=e=>{},$5=()=>L5,H5=e=>e,Ru=(e,t)=>{const r=bn(e);vn(t,i=>{const s=bn(i);r.family.type!=="domain"&&(s.family.type="crosslink"),zn(Vu(s),r),zn(Qu(r),s)})},Ls=(e=[])=>(Array.isArray(e)?e:[e]).flat().map(bn),ur=e=>typeof e=="object"&&e!==null,Ir=e=>typeof e=="function",Dn=e=>e===void 0,r2=e=>Tt(ur(e)||Ir(e),"expect first argument be an object"),Rw=(e,t,r,i)=>Tt(!(!ur(e)&&!Ir(e)||!("family"in e)&&!("graphite"in e)),`${t}: expect ${r} to be a unit (store, event or effect)${i}`),Ip=(e,t,r)=>{Array.isArray(e)?vn(e,(i,s)=>Rw(i,t,`${s} item of ${r}`,"")):Rw(e,t,r," or array of units")},I5=(e,t,r="target")=>vn(Ls(t),i=>Tt(!ya(i,"derived"),`${e}: derived unit in "${r}" is not supported, use createStore/createEvent instead"`)),a2=(e,{fn:t},{a:r})=>t(e,r),q5=(e,{fn:t},{a:r})=>t(r,e),Wu=(e,{fn:t})=>t(e),i2=(e,t,r,i)=>{const s={id:t2(),type:e,data:t};return r&&(s.order={priority:r},i&&(s.order.barrierID=++B5)),s};let B5=0;const Rn=({from:e="store",store:t,target:r,to:i=r?"store":"stack",batch:s,priority:l})=>i2("mov",{from:e,store:t,to:i,target:r},l,s),ol=({fn:e,batch:t,priority:r,safe:i=0,filter:s=0,pure:l=0})=>i2("compute",{fn:e,safe:i,filter:s,pure:l},r,t),Vm=({fn:e})=>ol({fn:e,priority:"effect"}),bo=(e,t,r)=>ol({fn:e,safe:1,filter:t,priority:r}),Ja=(e,t,r)=>Rn({store:e,to:t?"stack":"a",priority:r&&"sampler",batch:1}),zr=(e=Wu,t)=>ol({fn:e,pure:1,filter:t}),uu={mov:Rn,compute:ol,filter:({fn:e,pure:t})=>ol({fn:e,filter:1,pure:t}),run:Vm},wo=e=>({id:t2(),current:e,initial:e}),Xs=({current:e})=>e,qp=(e,t)=>{e.before||(e.before=[]),zn(e.before,t)};let lo=null;const Qm=(e,t)=>{if(!e)return t;if(!t)return e;let r;return(e.v.type===t.v.type&&e.v.id>t.v.id||Yp(e.v.type)>Yp(t.v.type))&&(r=e,e=t,t=r),r=Qm(e.r,t),e.r=e.l,e.l=r,e},Wm=[];let zw=0;for(;zw<6;)zn(Wm,{first:null,last:null,size:0}),zw+=1;const Y5=()=>{for(let e=0;e<6;e++){const t=Wm[e];if(t.size>0){if(e===3||e===4){t.size-=1;const i=lo.v;return lo=Qm(lo.l,lo.r),i}t.size===1&&(t.last=null);const r=t.first;return t.first=r.r,t.size-=1,r.v}}},Xa=(e,t,r,i,s,l,u)=>Bp(0,{a:null,b:null,node:r,parent:i,value:s,page:t,scope:l,meta:u},e,0),Bp=(e,t,r,i)=>{const s=Yp(r),l=Wm[s],u={v:{idx:e,stack:t,type:r,id:i},l:null,r:null};s===3||s===4?lo=Qm(lo,u):(l.size===0?l.first=u:l.last.r=u,l.last=u),l.size+=1},Yp=e=>{switch(e){case"child":return 0;case"pure":return 1;case"read":return 2;case"barrier":return 3;case"sampler":return 4;case"effect":return 5;default:return-1}},Qh=new Set;let it,Qc=1,Wh=0,du=0,Dr=null;const Dw=e=>{it=e},jw=e=>{Dr=e},o2=(e,t)=>{if(e){for(;e&&!e.reg[t];)e=e.parent;if(e)return e}return null},P5=(e,t,r,i)=>{const s=o2(e,r.id);return s?s.reg[r.id]:t?(xo(t,r,i),t.reg[r.id]):r},X5=e=>e,xo=(e,t,r,i,s)=>{const l=e.reg;if(l[t.id])return;const u=t.sid,d={id:t.id,current:t.initial,meta:t.meta};if(d.id in e.values.idMap)d.current=e.values.idMap[d.id];else if(u&&u in e.values.sidMap&&!(u in e.sidIdMap)){var h;const p=t==null||(h=t.meta)===null||h===void 0?void 0:h.serialize;d.current=(e.fromSerialize&&p!=="ignore"&&(p==null?void 0:p.read)||X5)(e.values.sidMap[u])}else if(t.before&&!s){let p=0;const y=r||!t.noInit||i;vn(t.before,g=>{switch(g.type){case"map":{const b=g.from;if((b||g.fn)&&(b&&xo(e,b,r,i),y)){const w=b&&l[b.id].current;d.current=g.fn?g.fn(w):w}break}case"field":xo(e,g.from,r,i),p||(p=1,d.current=Array.isArray(d.current)?[...d.current]:{...d.current}),y&&(d.current[g.field]=l[l[g.from.id].id].current)}})}u&&(e.sidIdMap[u]=t.id),l[t.id]=d},F5=(e,t,r)=>{try{return t(cu(r),e.scope,r)}catch(i){console.error(i),e.fail=1,e.failReason=i}},sl=(e,t={})=>(ur(e)&&(sl(e.or,t),Gu(e,(r,i)=>{Dn(r)||i==="or"||i==="and"||(t[i]=r)}),sl(e.and,t)),t),Uw=(e,t)=>{Vh(e.next,t),Vh(Vu(e),t),Vh(Qu(e),t)},Lw=["on","reset","sample","split","merge","guard","forward"],fu=(e,t,r,i,s)=>{let l;e.next.length=0,e.seq.length=0,e.scope=null;let u=Qu(e);const{stateRef:d,defaultShape:h,isRegion:p,op:y}=e.meta;if(d&&(d.before=[],e.meta.stateRef=null),h)for(const b in h)h[b]=null;const g=p?e:i;if(u.length>0){const b=Gh(Lw,y),w=!p&&!s,S=w&&r&&!b;for(;l=u.pop();){const T=Gh(l.next,e);Uw(l,e),p&&fu(l,0,0,e,1),T||(l.family.triggers-=1),(t||S||w&&l.family.type==="crosslink"&&!b||s&&Gh(Lw,l.meta.op)&&(T&&l.next.length===0||!T&&l.family.triggers<=0))&&fu(l,t,r&&l.meta.op!=="on",g,s)}}for(u=Vu(e);l=u.pop();)Uw(l,e),r&&l.family.type==="crosslink"&&fu(l,t,l.meta.op!=="on",g,s)},Wc=e=>e.clear(),zu=(e,{deep:t}={})=>{let r=0;if(e.ownerSet&&e.ownerSet.delete(e),e2(e)){r=1;const i=e.history;Wc(i.events),Wc(i.effects),Wc(i.stores),Wc(i.domains)}fu(bn(e),!!t,r,null,0)},G5=e=>Hp(()=>zu(e)),ii=(e,t,r,i,s)=>$r({node:r,parent:e,child:t,scope:{fn:s},meta:{op:i},family:{owners:[e,t],links:t},regional:1}),s2=(e,t)=>(Tt(Ir(t),".watch argument should be a function"),G5($r({scope:{fn:t},node:[Vm({fn:Wu})],parent:e,meta:{op:"watch"},family:{owners:e},regional:1}))),V5=(e,t,r="event")=>{al(e)&&al(e).hooks[r](t)},l2=(e,t)=>Rr(e,"unitTrace",t),Zu=e=>{const t=Error("unit trace");return Error.captureStackTrace&&Error.captureStackTrace(t,e),t.stack},c2=(e,t,r,i)=>{const s=sl(r),l=e==="domain",u=j5(),{sid:d=null,named:h=null,domain:p=null,parent:y=p}=s,g=h||s.name||(l?"":u),b=E5(g,y),w={op:t.kind=e,name:t.shortName=g,sid:t.sid=H5(d),named:h,unitId:t.id=u,serialize:s.serialize,derived:s.derived,config:s,unitTrace:i};return t.targetable=!s.derived,t.parent=y,t.compositeName=b,t.defaultConfig=s,t.getType=()=>(il(0,"getType","compositeName.fullName"),b.fullName),!l&&(t.subscribe=S=>(r2(S),t.watch(Ir(S)?S:T=>S.next&&S.next(T))),t[A5]=()=>t),w},Zh=(e,t,r,i)=>{let s;ur(r)&&(s=r,r=r.fn);const l=Ge({name:`${e.shortName} → *`,derived:1,and:s});return ii(e,l,i,t,r),l},hu="undefined is used to skip updates. To allow undefined as a value provide explicit { skipVoid: false } option",u2=(e,t,r,i,s)=>{const l=sr(t),u=Rn({store:l,to:"a",priority:"read"});r===yo&&(u.data.softRead=1);const d=[u,zr(i)];Vn("storeOnMap",l,d,Un(e)&&sr(e));const h=ii(e,t,d,r,s);return r!==yo&&Rr(h,"onTrigger",bn(e).id),h},Q5=(e,t,r,i,s,l,u)=>{const d=di("combine",s),h=e?C=>[...C]:C=>({...C}),p=e?[]:{},y=h(p),g=wo(y),b=wo(1);g.type=e?"list":"shape",g.noInit=1,Vn("combineBase",g,b);const w=At(y,{name:k5(r),derived:1,...u,and:s});l2(w,i);const S=sr(w);S.noInit=1,Rr(w,"isCombine",1),Ru(w,[$r({meta:{stateRef:g}})]);const T=Ja(g);T.order={priority:"barrier"};const E=Rn({store:S,to:"b",priority:"read"});E.data.softRead=1;const _=[bo((C,O,L)=>(L.scope&&!L.scope.reg[g.id]&&(L.c=1),C)),T,Rn({store:b,to:"b"}),bo((C,{key:O},L)=>{if(L.c||C!==L.a[O])return t&&L.b&&(L.a=h(L.a)),L.a[O]=C,1},1),Rn({from:"a",target:g}),Rn({from:"value",store:0,target:b}),Rn({from:"value",store:1,target:b,priority:"barrier",batch:1}),Ja(g,1,1),l&&zr(),E];if(Gu(r,(C,O)=>{if(!Un(C))return Tt(!Sa(C)&&!Dn(C),`combine expects a store in a field ${O}`,d),void(y[O]=p[O]=C);p[O]=C.defaultState,y[O]=C.getState();const L=ii(C,w,_,"combine",l);L.scope.key=O;const j=sr(C);qp(g,{type:"field",field:O,from:j}),Vn("combineField",j,L)}),w.defaultShape=r,Rr(w,"defaultShape",r),qp(S,{type:yo,from:g,fn:l}),l){const C=l(y);!Dn(C)||u&&"skipVoid"in u||console.error(`${d}: ${hu}`),S.current=C,S.initial=C,w.defaultState=C}else w.defaultState=p;return w};$r({node:[Vm({fn:({fn:e,value:t})=>e(t)})],meta:{op:"fx",fx:"sidechain"}});const W5=["source","clock","target"],d2=(e,t)=>e+`: ${t} should be defined`,Z5=(e,t,r,i,s,l,u,d,h,p,y,g)=>{const b=di(e,d),w=!!s;Tt(!Dn(r)||!Dn(t),d2(b,"either source or clock"));let S=0;Dn(r)?S=1:Sa(r)||(r=ai(r)),Dn(t)?t=r:(Ip(t,b,"clock"),Array.isArray(t)&&(t=ii(t,[],[],e))),S&&(r=t),d||u?d&&u?d.name=u:!d&&u&&(d={name:u}):u=r.shortName;let T="none";i&&(Sa(i)?T="unit":(Tt(Ir(i),"`filter` should be function or unit"),T="fn")),s?(Ip(s,b,"target"),I5(b,s)):T==="none"&&p&&Un(r)&&Un(t)?s=At(l?l(Xs(sr(r)),Xs(sr(t))):Xs(sr(r)),{name:u,sid:g,or:d}):(s=Ge({name:u,derived:1,or:d}),Vn("sampleTarget",bn(s)));const E=wo();let _=[];const C=[];if(T==="unit"){const[j,X,G,ee]=$w(i,s,t,E,e);ee&&zn(C,ee),G||_.push(...Kh(X)),_.push(...Kh(j))}const O=[];if(S)h&&zn(O,Ja(E,1,1));else{const[j,X,G,ee]=$w(r,s,t,E,e);ee&&zn(C,ee),G||O.push(...Kh(X)),zn(O,Ja(j,1,h))}const L=ii(t,s,[Vn(),Rn({from:"stack",target:E}),...O,..._,Ja(E),T==="fn"&&zr((j,X,{a:G})=>i(j,G),1),l&&zr(a2),Vn("sampleSourceUpward",w)],e,l);return Ru(r,[L]),Ru(L,C),Object.assign(L.meta,d,{joint:1,stateRef:E}),l2(L,Zu(Co)),s},Kh=e=>[Ja(e),bo((t,r,{a:i})=>i,1)],$w=(e,t,r,i,s)=>{const l=Un(e),u=l?sr(e):wo(),d=wo(l);let h;return l||(h=$r({parent:e,node:[Rn({from:"stack",target:u}),Rn({from:"value",store:1,target:d})],family:{owners:[...new Set([e,t,r].flat())],links:t},meta:{op:s},regional:1})),Vn("sampleSource",d,u,i),[u,d,l,h]};var Jh={exports:{}},ep={};/**
 * @license React
