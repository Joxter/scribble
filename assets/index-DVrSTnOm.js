 ...
 */var ub;function UT(){if(ub)return ks;ub=1;var e=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function r(i,s,l){var u=null;if(l!==void 0&&(u=""+l),s.key!==void 0&&(u=""+s.key),"key"in s){l={};for(var d in s)d!=="key"&&(l[d]=s[d])}else l=s;return s=l.ref,{$$typeof:e,type:i,key:u,ref:s!==void 0?s:null,props:l}}return ks.Fragment=t,ks.jsx=r,ks.jsxs=r,ks}var db;function LT(){return db||(db=1,gh.exports=UT()),gh.exports}var D=LT();/**
 * @license bippy
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const $T="0.3.18",mm=`bippy-${$T}`,fb=Object.defineProperty,HT=Object.prototype.hasOwnProperty,Ds=()=>{},_1=e=>{try{Function.prototype.toString.call(e).indexOf("^_^")>-1&&setTimeout(()=>{throw new Error("React is running in production mode, but dead code elimination has not been applied. Read how to correctly configure React for production: https://reactjs.org/link/perf-use-production-build")})}catch{}},S1=(e=ti())=>"getFiberRoots"in e;let T1=!1,$c;const hp=(e=ti())=>T1?!0:(typeof e.inject=="function"&&($c=e.inject.toString()),!!($c!=null&&$c.includes("(injected)"))),ru=new Set,pp=new Set,IT=e=>{const t=new Map;let r=0,i={checkDCE:_1,supportsFiber:!0,supportsFlight:!0,hasUnsupportedRendererAttached:!1,renderers:t,onCommitFiberRoot:Ds,onCommitFiberUnmount:Ds,onPostCommitFiberRoot:Ds,on:Ds,inject(s){const l=++r;return t.set(l,s),pp.add(s),i._instrumentationIsActive||(i._instrumentationIsActive=!0,ru.forEach(u=>u())),l},_instrumentationSource:mm,_instrumentationIsActive:!1};try{fb(globalThis,"__REACT_DEVTOOLS_GLOBAL_HOOK__",{get(){return i},set(u){if(u&&typeof u=="object"){const d=i.renderers;i=u,d.size>0&&(d.forEach((h,p)=>{pp.add(h),u.renderers.set(p,h)}),mp(e))}},configurable:!0,enumerable:!0});const s=window.hasOwnProperty;let l=!1;fb(window,"hasOwnProperty",{value:function(){try{if(!l&&arguments[0]==="__REACT_DEVTOOLS_GLOBAL_HOOK__")return globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__=void 0,l=!0,-0}catch{}return s.apply(this,arguments)},configurable:!0,writable:!0})}catch{mp(e)}return i},mp=e=>{e&&ru.add(e);try{const t=globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!t)return;if(!t._instrumentationSource){if(t.checkDCE=_1,t.supportsFiber=!0,t.supportsFlight=!0,t.hasUnsupportedRendererAttached=!1,t._instrumentationSource=mm,t._instrumentationIsActive=!1,t.on=Ds,t.renderers.size){t._instrumentationIsActive=!0,ru.forEach(i=>i());return}const r=t.inject;hp(t)&&!S1()&&(T1=!0,t.inject({scheduleRefresh(){}})&&(t._instrumentationIsActive=!0)),t.inject=i=>{const s=r(i);return pp.add(i),t._instrumentationIsActive=!0,ru.forEach(l=>l()),s}}(t.renderers.size||t._instrumentationIsActive||hp())&&(e==null||e())}catch{}},qT=()=>HT.call(globalThis,"__REACT_DEVTOOLS_GLOBAL_HOOK__"),ti=e=>qT()?(mp(e),globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__):IT(e),BT=()=>{var e,t;return!!(typeof window<"u"&&((e=window.document)!=null&&e.createElement||((t=window.navigator)==null?void 0:t.product)==="ReactNative"))},YT=()=>{try{BT()&&ti()}catch{}};/**
 * @license bippy
 *
 * Copyright (c) Aiden Bai
 *
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kw;function a5(){if(kw)return Xh;kw=1;var e=pl();function t(g,b){return g===b&&(g!==0||1/g===1/b)||g!==g&&b!==b}var r=typeof Object.is=="function"?Object.is:t,i=e.useState,s=e.useEffect,l=e.useLayoutEffect,u=e.useDebugValue;function d(g,b){var w=b(),S=i({inst:{value:w,getSnapshot:b}}),T=S[0].inst,k=S[1];return l(function(){T.value=w,T.getSnapshot=b,h(T)&&k({inst:T})},[g,w,b]),s(function(){return h(T)&&k({inst:T}),g(function(){h(T)&&k({inst:T})})},[g]),u(w),w}function h(g){var b=g.getSnapshot;g=g.value;try{var w=b();return!r(g,w)}catch{return!0}}function p(g,b){return b()}var y=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?p:d;return Xh.useSyncExternalStore=e.useSyncExternalStore!==void 0?e.useSyncExternalStore:y,Xh}var Ew;function $x(){return Ew||(Ew=1,Ph.exports=a5()),Ph.exports}var Hx=$x();const i5=pm(Hx),o5=Vk.useInsertionEffect,s5=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",l5=s5?ce.useLayoutEffect:ce.useEffect,c5=o5||l5,Ix=e=>{const t=ce.useRef([e,(...r)=>t[0](...r)]).current;return c5(()=>{t[0]=e}),t[1]},u5="popstate",Pm="pushState",Xm="replaceState",d5="hashchange",Cw=[u5,Pm,Xm,d5],f5=e=>{for(const t of Cw)addEventListener(t,e);return()=>{for(const t of Cw)removeEventListener(t,e)}},qx=(e,t)=>Hx.useSyncExternalStore(f5,e,t),h5=()=>location.search,p5=({ssrSearch:e=""}={})=>qx(h5,()=>e),Mw=()=>location.pathname,m5=({ssrPath:e}={})=>qx(Mw,e?()=>e:Mw),g5=(e,{replace:t=!1,state:r=null}={})=>history[t?Xm:Pm](r,"",e),v5=(e={})=>[m5(e),g5],Nw=Symbol.for("wouter_v3");if(typeof history<"u"&&typeof window[Nw]>"u"){for(const e of[Pm,Xm]){const t=history[e];history[e]=function(){const r=t.apply(this,arguments),i=new Event(e);return i.arguments=arguments,dispatchEvent(i),r}}Object.defineProperty(window,Nw,{value:!0})}const y5=(e,t)=>t.toLowerCase().indexOf(e.toLowerCase())?"~"+t:t.slice(e.length)||"/",Bx=(e="")=>e==="/"?"":e,b5=(e,t)=>e[0]==="~"?e.slice(1):Bx(t)+e,w5=(e="",t)=>y5(Ow(Bx(e)),Ow(t)),Ow=e=>{try{return decodeURI(e)}catch{return e}},Yx={hook:v5,searchHook:p5,parser:r5,base:"",ssrPath:void 0,ssrSearch:void 0,ssrContext:void 0,hrefs:e=>e},Px=ce.createContext(Yx),gl=()=>ce.useContext(Px),Xx={},Fx=ce.createContext(Xx),x5=()=>ce.useContext(Fx),Gu=e=>{const[t,r]=e.hook(e);return[w5(e.base,t),Ix((i,s)=>r(b5(i,e.base),s))]},Fm=()=>Gu(gl()),Gx=(e,t,r,i)=>{const{pattern:s,keys:l}=t instanceof RegExp?{keys:!1,pattern:t}:e(t||"*",i),u=s.exec(r)||[],[d,...h]=u;return d!==void 0?[!0,(()=>{const p=l!==!1?Object.fromEntries(l.map((g,b)=>[g,h[b]])):u.groups;let y={...h};return p&&Object.assign(y,p),y})(),...i?[d]:[]]:[!1,null]},_5=({children:e,...t})=>{var y,g;const r=gl(),i=t.hook?Yx:r;let s=i;const[l,u]=((y=t.ssrPath)==null?void 0:y.split("?"))??[];u&&(t.ssrSearch=u,t.ssrPath=l),t.hrefs=t.hrefs??((g=t.hook)==null?void 0:g.hrefs);let d=ce.useRef({}),h=d.current,p=h;for(let b in i){const w=b==="base"?i[b]+(t[b]||""):t[b]||i[b];h===p&&w!==p[b]&&(d.current=p={...p}),p[b]=w,(w!==i[b]||w!==s[b])&&(s=p)}return ce.createElement(Px.Provider,{value:s,children:e})},Aw=({children:e,component:t},r)=>t?ce.createElement(t,{params:r}):typeof e=="function"?e(r):e,S5=e=>{let t=ce.useRef(Xx);const r=t.current;return t.current=Object.keys(e).length!==Object.keys(r).length||Object.entries(e).some(([i,s])=>s!==r[i])?e:r},ro=({path:e,nest:t,match:r,...i})=>{const s=gl(),[l]=Gu(s),[u,d,h]=r??Gx(s.parser,e,l,t),p=S5({...x5(),...d});if(!u)return null;const y=h?ce.createElement(_5,{base:h},Aw(i,p)):Aw(i,p);return ce.createElement(Fx.Provider,{value:p,children:y})},ao=ce.forwardRef((e,t)=>{const r=gl(),[i,s]=Gu(r),{to:l="",href:u=l,onClick:d,asChild:h,children:p,className:y,replace:g,state:b,...w}=e,S=Ix(k=>{k.ctrlKey||k.metaKey||k.altKey||k.shiftKey||k.button!==0||(d==null||d(k),k.defaultPrevented||(k.preventDefault(),s(u,e)))}),T=r.hrefs(u[0]==="~"?u.slice(1):r.base+u,r);return h&&ce.isValidElement(p)?ce.cloneElement(p,{onClick:S,href:T}):ce.createElement("a",{...w,onClick:S,href:T,className:y!=null&&y.call?y(i===u):y,children:p,ref:t})}),Vx=e=>Array.isArray(e)?e.flatMap(t=>Vx(t&&t.type===ce.Fragment?t.props.children:t)):[e],T5=({children:e,location:t})=>{const r=gl(),[i]=Gu(r);for(const s of Vx(e)){let l=0;if(ce.isValidElement(s)&&(l=Gx(r.parser,s.props.path,t||i,s.props.nest))[0])return ce.cloneElement(s,{match:l})}return null};function Vu(e,t){for(const r in e)t(e[r],r)}function vn(e,t){e.forEach(t)}function Tt(e,t,r){if(!e)throw Error(`${r?r+": ":""}${t}`)}function Ir({node:e=[],from:t,source:r,parent:i=t||r,to:s,target:l,child:u=s||l,scope:d={},meta:h={},family:p={type:"regular"},regional:y}={}){const g=Ls(i),b=Ls(p.links),w=Ls(p.owners),S=[];vn(e,k=>k&&zn(S,k));const T={id:j5(),seq:S,next:Ls(u),meta:h,scope:d,family:{triggers:g.length,type:p.type||"crosslink",links:b,owners:w}};return vn(b,k=>zn(Qu(k),T)),vn(w,k=>zn(Wu(k),T)),vn(g,k=>zn(k.next,T)),T}function Qx(e,t,r){let i,s=jr,l=null,u=at;if(e.target&&(t=e.params,r=e.defer,i=e.meta,s="page"in e?e.page:s,e.stack&&(l=e.stack),u=Qc(e)||u,e=e.target),u&&at&&u!==at&&(at=null),Array.isArray(e))for(let S=0;S<e.length;S++)Fa("pure",s,bn(e[S]),l,t[S],u,i);else Fa("pure",s,bn(e),l,t,u,i);if(r&&!Wc)return;const d={isRoot:Wc,currentPage:jr,scope:at,isWatch:Qh,isPure:fu};let h,p,y,g,b,w;Wc=0;e:for(;g=B5();){const{idx:S,stack:T,type:k}=g;y=T.node,jr=b=T.page,at=Qc(T),b?w=b.reg:at&&(w=at.reg);const _=!!b,M=!!at,O={fail:0,scope:y.scope};h=p=0;for(let L=S;L<y.seq.length&&!h;L++){const j=y.seq[L];if(j.order){const{priority:X,barrierID:G}=j.order,ee=G?b?`${b.fullID}_${G}`:G:0;if(L!==S||k!==X){G?Vh.has(ee)||(Vh.add(ee),Bp(L,T,X,G)):Bp(L,T,X,0);continue e}G&&Vh.delete(ee)}switch(j.type){case"mov":{const G=j.data;let ee;switch(G.from){case"stack":ee=uu(T);break;case"a":case"b":ee=T[G.from];break;case"value":ee=G.store;break;case"store":if(w&&!w[G.store.id])if(_){const ne=i2(b,G.store.id);T.page=b=ne,ne?w=ne.reg:M?(xo(at,G.store,0,1,G.softRead),w=at.reg):w=void 0}else M&&xo(at,G.store,0,1,G.softRead);ee=Xs(w&&w[G.store.id]||G.store)}switch(G.to){case"stack":T.value=ee;break;case"a":case"b":T[G.to]=ee;break;case"store":Y5(b,at,G.target,0).current=ee}break}case"compute":const X=j.data;if(X.fn){Qh=y.meta.op==="watch",fu=X.pure;const G=X.safe?(0,X.fn)(uu(T),O.scope,T):X5(O,X.fn,T);X.filter?p=!G:T.value=G,Qh=d.isWatch,fu=d.isPure}}h=O.fail||p}if(!h){const L=uu(T),j=Qc(T);if(vn(y.next,X=>{Fa("child",b,X,T,L,j)}),j){y.meta.needFxCounter&&Fa("child",b,j.fxCount,T,L,j),y.meta.storeChange&&Fa("child",b,j.storeChange,T,L,j),y.meta.warnSerialize&&Fa("child",b,j.warnSerializeNode,T,L,j);const X=j.additionalLinks[y.id];X&&vn(X,G=>{Fa("child",b,G,T,L,j)})}}}Wc=d.isRoot,jr=d.currentPage,at=Qc(d)}function k5(e,t="combine"){let r=t+"(",i="",s=0;return Vu(e,l=>{s<25&&(l!=null&&(r+=i,r+=Ta(l)?Zx(l).fullName:l.toString()),s+=1,i=", ")}),r+")"}function E5(e,t){let r,i;const s=e;if(t){const l=Zx(t);e.length===0?(r=l.path,i=l.fullName):(r=l.path.concat([e]),i=l.fullName.length===0?e:l.fullName+"/"+e)}else r=e.length===0?[]:[e],i=e;return{shortName:s,fullName:i,path:r}}function ui(e,t){if(!t||!t.name&&!t.named&&!t.loc)return e;let r=`[${e}]`;const i=t.named||t.name;i&&(r+=` unit '${i}'`);const s=t.loc;return!i&&s&&(r+=` (${s.file}:${s.line}:${s.column})`),r}function Gm(e,t){const r=t?e:e[0];n2(r);let i=r.or;const s=r.and;if(s){const l=s[0];if(dr(l)&&"and"in l){const u=Gm(s,t);e=u[0],i={...i,...u[1]}}else e=s}return[e,i]}function Hp(e){const t=()=>e();return t.unsubscribe=()=>e(),t}function Qn(e,...t){}function qe(e,t){const r=sl({or:t,and:typeof e=="string"?{name:e}:e}),i=ui("event",r),s=(d,...h)=>(Tt(!ba(s,"derived"),"call of derived event is not supported, use createEvent instead",i),Tt(!fu,"unit call from pure function is not supported, use operators like sample instead",i),jr?((p,y,g,b)=>{const w=jr;Uw(null);const T=p.create(g,b);return Uw(w),T})(s,l,d,h):s.create(d,h)),l=L5(),u=Object.assign(s,{graphite:Ir({meta:l2(r.actualOp||"event",s,r,Ku(qe)),regional:1}),create:d=>(Qx({target:s,params:d,scope:at}),d),watch:d=>o2(s,d),map:d=>Wh(s,yo,d,[Dr()]),filter:d=>Wh(s,"filter",d.fn?d:d.fn,[Dr(Zu,1)]),filterMap:d=>Wh(s,"filterMap",d,[Dr(),bo(h=>!Dn(h),1)]),prepend(d){Tt(s.targetable,".prepend of derived event is not supported, call source event instead",i);const h=qe("* → "+s.shortName,{parent:al(s)});return Qn("eventPrepend",bn(h)),ai(h,s,[Dr()],"prepend",d),G5(s,h),h}});return r!=null&&r.domain&&r.domain.hooks.event(u),zr(u,"id",u.graphite.id),t2(u.graphite),u}function Rw(e,t,r,i,s){return Ip(r,`${s} ${t}`,"first argument"),Tt(Br(i),"second argument should be a function",s),il(!ba(e,"derived"),`${t} in derived store`,`${t} in store created via createStore`,s),vn(Array.isArray(r)?r:[r],l=>{e.off(l),c2(l,e,"on",I5,i)}),e}function kt(e,t){const r=sl(t),i=wo(e),s=ui("store",r),l=qe({named:"updates",derived:1});Qn("storeBase",i);const u=i.id,d="skipVoid"in r,h=d&&!r.skipVoid;il(!(d&&r.skipVoid),"{skipVoid: true}","updateFilter",s);const p={updates:l,defaultState:e,stateRef:i,getState(){let _,M=i;if(jr){let O=jr;for(;O&&!O.reg[u];)O=al(O);O&&(_=O)}return!_&&at&&(xo(at,i,1),_=at),_&&(M=_.reg[u]),Xs(M)},setState:_=>Qx({target:p,params:_,defer:1,scope:at}),reset:(..._)=>(Tt(p.targetable,".reset of derived store is not supported",s),vn(_,M=>Rw(p,".reset",M,()=>p.defaultState,s)),p),on:(_,M)=>(Tt(p.targetable,".on of derived store is not supported",s),Rw(p,".on",_,M,s)),off(_){const M=bn(_).id,O=bn(p).family.links.find(L=>L.meta.onTrigger===M);return O&&Du(O),p},map(_,M){let O,L;dr(_)&&(O=_,_=_.fn);const j=p.getState(),X=Dn(j);(!X||X&&h)&&(L=_(j));const G=kt(L,{name:`${p.shortName} → *`,derived:1,...M,and:O}),ee=c2(p,G,yo,Zu,_);return qp(lr(G),{type:yo,fn:_,from:i}),lr(G).noInit=1,Qn("storeMap",i,ee),G},watch(_,M){if(il(!M,"watch second argument","sample",s),!M||!Ta(_)){const O=o2(p,_);return Qn("storeWatch",i,_)||_(p.getState()),O}return Tt(Br(M),"second argument should be a function",s),_.watch(O=>M(p.getState(),O))}},y=l2("store",p,r,Ku(kt)),g=p.defaultConfig.updateFilter;p.graphite=Ir({scope:{state:i,fn:g},node:[bo((_,M,O)=>(O.scope&&!O.scope.reg[i.id]&&(O.b=1),_)),Ja(i),bo((_,M,{a:O,b:L})=>{const j=Dn(_);return j&&!d&&z5(`${s}: ${pu}`,ba(p,"unitTrace")),(j&&h||!j)&&(_!==O||L)},1),g&&Dr(r2,1),Rn({from:"stack",target:i})],child:l,meta:{...y,defaultState:e,stateRef:i},regional:1}),zr(p,"id",p.graphite.id),zr(p,"rootStateRefId",u);const b=ba(p,"serialize"),w=ba(p,"derived"),S=b==="ignore",T=ba(p,"sid");T&&(zr(p,"storeChange",1),i.sid=T),T||S||w||zr(p,"warnSerialize",1);const k=Dn(e);return Tt(w||!k||k&&h,pu,s),w&&k&&!d&&console.error(`${s}: ${pu}`),zu(p,[l]),r!=null&&r.domain&&r.domain.hooks.store(p),w||(p.reinit=qe({named:"reinit"}),p.reset(p.reinit)),i.meta=p.graphite.meta,t2(p.graphite),p}function Lr(...e){let t,r,i;[e,i]=Gm(e);const s=ui("combine",i),l=e[e.length-1],u=e.length>1&&!Un(l)&&dr(l),d=u&&l,h=u?e[e.length-2]:l;let p,y,g;if(Br(h)?(r=e.slice(0,u?-2:-1),t=h):r=e,r.length===1){const b=r[0];Un(b)||(p=b,y=1)}if(!y&&(p=r,t)){g=1;const b=t;t=w=>b(...w)}return Tt(dr(p),`${s}: shape should be an object`),V5(Array.isArray(p),!g,p,Ku(Lr),i,t,d)}function C5(e,t){let r=0;return vn(Q5,i=>{i in e&&(Tt(e[i]!=null,u2(t,i)),r=1)}),r}function vl(...e){let t,r,i,s,[[l,u,d],h]=Gm(e),p=1;const y=ui("sample",h);return Dn(u)&&dr(l)&&C5(l,y)&&(u=l.clock,d=l.fn,"batch"in l?p=l.batch:(il(!("greedy"in l),"greedy in sample","batch",y),p=!l.greedy),s=l.filter,t=l.target,r=l.name,i=l.sid,l=l.source),W5("sample",u,l,s,t,d,r,h,p,1,0,i)}function Co(e,t,r){const i=ui("restore",r);if(Tt(!Un(e),"restore($store) is not supported",i),Kx(e)||Ru(e)){const l=al(e),u=kt(t,{parent:l,name:e.shortName,and:r});return ai(Ru(e)?e.doneData:e,u),l&&l.hooks.store(u),u}const s=Array.isArray(e)?[]:{};return Vu(e,(l,u)=>s[u]=Un(l)?l:kt(l,{name:u})),s}function M5(e,{scope:t,safe:r}={}){Tt(t||at||r,"scopeBind: scope not found");const i=t||at;return(...s)=>{function l(){jw(h)}let u,d=0;const h=at;jw(i);try{u=e(...s)}catch(p){u=p,d=1}if(l(),d)throw u;return u instanceof Promise&&u.then(l,l),u}}function Wx({unit:e,fn:t,scope:r,batch:i}){const s=[du.run({fn:u=>t(u)})];i&&s.unshift(du.compute({priority:"sampler",batch:1})),Un(e)&&s.unshift(du.mov({store:e.stateRef,to:"stack"}));const l=Array.isArray(e)?e:[e];if(r){const u=[],d=r.additionalLinks;return l.forEach(h=>{const p=d[h.graphite.id]||[];d[h.graphite.id]=p;const y=Ir({node:N5(s,h),meta:{watchOp:h.kind}});p.push(y),u.push(()=>{const g=p.indexOf(y);g!==-1&&p.splice(g,1),Du(y)})}),Hp(()=>{u.forEach(h=>h())})}{const u=Ir({node:s,parent:l,family:{owners:l}});return Hp(()=>{Du(u)})}}function N5(e,t){return Un(t)?[du.mov({store:t.stateRef,to:"stack"}),...e]:e}const O5=typeof Symbol<"u"&&Symbol.observable||"@@observable",yo="map",bn=e=>e.graphite||e,Qu=e=>e.family.owners,Wu=e=>e.family.links,lr=e=>e.stateRef,uu=e=>e.value,al=e=>e.parent,Qc=e=>e.scope,ba=(e,t)=>bn(e).meta[t],zr=(e,t,r)=>bn(e).meta[t]=r,Zx=e=>e.compositeName,Ta=e=>(Br(e)||dr(e))&&"kind"in e,yl=e=>t=>Ta(t)&&t.kind===e,Un=yl("store"),Kx=yl("event"),Ru=yl("effect"),A5=e=>Ta(e)&&!!e.targetable,Jx=yl("domain"),R5=yl("scope");var Us={__proto__:null,unit:Ta,store:Un,event:Kx,effect:Ru,targetable:A5,domain:Jx,scope:R5,attached:e=>Ru(e)&&ba(e,"attached")==1};const Fh=(e,t)=>e.includes(t),Gh=(e,t)=>{const r=e.indexOf(t);r!==-1&&e.splice(r,1)},zn=(e,t)=>e.push(t),il=(e,t,r,i)=>!e&&console.error(`${i?i+": ":""}${t} is deprecated${r?`, use ${r} instead`:""}`),z5=(e,t)=>{const r=Error(e);r.stack=t,console.error(r)},Vm=()=>{let e=0;return()=>""+ ++e},D5=Vm(),e2=Vm(),j5=Vm();let U5=null;const t2=e=>{},L5=()=>U5,$5=e=>e,zu=(e,t)=>{const r=bn(e);vn(t,i=>{const s=bn(i);r.family.type!=="domain"&&(s.family.type="crosslink"),zn(Qu(s),r),zn(Wu(r),s)})},Ls=(e=[])=>(Array.isArray(e)?e:[e]).flat().map(bn),dr=e=>typeof e=="object"&&e!==null,Br=e=>typeof e=="function",Dn=e=>e===void 0,n2=e=>Tt(dr(e)||Br(e),"expect first argument be an object"),zw=(e,t,r,i)=>Tt(!(!dr(e)&&!Br(e)||!("family"in e)&&!("graphite"in e)),`${t}: expect ${r} to be a unit (store, event or effect)${i}`),Ip=(e,t,r)=>{Array.isArray(e)?vn(e,(i,s)=>zw(i,t,`${s} item of ${r}`,"")):zw(e,t,r," or array of units")},H5=(e,t,r="target")=>vn(Ls(t),i=>Tt(!ba(i,"derived"),`${e}: derived unit in "${r}" is not supported, use createStore/createEvent instead"`)),r2=(e,{fn:t},{a:r})=>t(e,r),I5=(e,{fn:t},{a:r})=>t(r,e),Zu=(e,{fn:t})=>t(e),a2=(e,t,r,i)=>{const s={id:e2(),type:e,data:t};return r&&(s.order={priority:r},i&&(s.order.barrierID=++q5)),s};let q5=0;const Rn=({from:e="store",store:t,target:r,to:i=r?"store":"stack",batch:s,priority:l})=>a2("mov",{from:e,store:t,to:i,target:r},l,s),ol=({fn:e,batch:t,priority:r,safe:i=0,filter:s=0,pure:l=0})=>a2("compute",{fn:e,safe:i,filter:s,pure:l},r,t),Qm=({fn:e})=>ol({fn:e,priority:"effect"}),bo=(e,t,r)=>ol({fn:e,safe:1,filter:t,priority:r}),Ja=(e,t,r)=>Rn({store:e,to:t?"stack":"a",priority:r&&"sampler",batch:1}),Dr=(e=Zu,t)=>ol({fn:e,pure:1,filter:t}),du={mov:Rn,compute:ol,filter:({fn:e,pure:t})=>ol({fn:e,filter:1,pure:t}),run:Qm},wo=e=>({id:e2(),current:e,initial:e}),Xs=({current:e})=>e,qp=(e,t)=>{e.before||(e.before=[]),zn(e.before,t)};let so=null;const Wm=(e,t)=>{if(!e)return t;if(!t)return e;let r;return(e.v.type===t.v.type&&e.v.id>t.v.id||Yp(e.v.type)>Yp(t.v.type))&&(r=e,e=t,t=r),r=Wm(e.r,t),e.r=e.l,e.l=r,e},Zm=[];let Dw=0;for(;Dw<6;)zn(Zm,{first:null,last:null,size:0}),Dw+=1;const B5=()=>{for(let e=0;e<6;e++){const t=Zm[e];if(t.size>0){if(e===3||e===4){t.size-=1;const i=so.v;return so=Wm(so.l,so.r),i}t.size===1&&(t.last=null);const r=t.first;return t.first=r.r,t.size-=1,r.v}}},Fa=(e,t,r,i,s,l,u)=>Bp(0,{a:null,b:null,node:r,parent:i,value:s,page:t,scope:l,meta:u},e,0),Bp=(e,t,r,i)=>{const s=Yp(r),l=Zm[s],u={v:{idx:e,stack:t,type:r,id:i},l:null,r:null};s===3||s===4?so=Wm(so,u):(l.size===0?l.first=u:l.last.r=u,l.last=u),l.size+=1},Yp=e=>{switch(e){case"child":return 0;case"pure":return 1;case"read":return 2;case"barrier":return 3;case"sampler":return 4;case"effect":return 5;default:return-1}},Vh=new Set;let at,Wc=1,Qh=0,fu=0,jr=null;const jw=e=>{at=e},Uw=e=>{jr=e},i2=(e,t)=>{if(e){for(;e&&!e.reg[t];)e=e.parent;if(e)return e}return null},Y5=(e,t,r,i)=>{const s=i2(e,r.id);return s?s.reg[r.id]:t?(xo(t,r,i),t.reg[r.id]):r},P5=e=>e,xo=(e,t,r,i,s)=>{const l=e.reg;if(l[t.id])return;const u=t.sid,d={id:t.id,current:t.initial,meta:t.meta};if(d.id in e.values.idMap)d.current=e.values.idMap[d.id];else if(u&&u in e.values.sidMap&&!(u in e.sidIdMap)){var h;const p=t==null||(h=t.meta)===null||h===void 0?void 0:h.serialize;d.current=(e.fromSerialize&&p!=="ignore"&&(p==null?void 0:p.read)||P5)(e.values.sidMap[u])}else if(t.before&&!s){let p=0;const y=r||!t.noInit||i;vn(t.before,g=>{switch(g.type){case"map":{const b=g.from;if((b||g.fn)&&(b&&xo(e,b,r,i),y)){const w=b&&l[b.id].current;d.current=g.fn?g.fn(w):w}break}case"field":xo(e,g.from,r,i),p||(p=1,d.current=Array.isArray(d.current)?[...d.current]:{...d.current}),y&&(d.current[g.field]=l[l[g.from.id].id].current)}})}u&&(e.sidIdMap[u]=t.id),l[t.id]=d},X5=(e,t,r)=>{try{return t(uu(r),e.scope,r)}catch(i){console.error(i),e.fail=1,e.failReason=i}},sl=(e,t={})=>(dr(e)&&(sl(e.or,t),Vu(e,(r,i)=>{Dn(r)||i==="or"||i==="and"||(t[i]=r)}),sl(e.and,t)),t),Lw=(e,t)=>{Gh(e.next,t),Gh(Qu(e),t),Gh(Wu(e),t)},$w=["on","reset","sample","split","merge","guard","forward"],hu=(e,t,r,i,s)=>{let l;e.next.length=0,e.seq.length=0,e.scope=null;let u=Wu(e);const{stateRef:d,defaultShape:h,isRegion:p,op:y}=e.meta;if(d&&(d.before=[],e.meta.stateRef=null),h)for(const b in h)h[b]=null;const g=p?e:i;if(u.length>0){const b=Fh($w,y),w=!p&&!s,S=w&&r&&!b;for(;l=u.pop();){const T=Fh(l.next,e);Lw(l,e),p&&hu(l,0,0,e,1),T||(l.family.triggers-=1),(t||S||w&&l.family.type==="crosslink"&&!b||s&&Fh($w,l.meta.op)&&(T&&l.next.length===0||!T&&l.family.triggers<=0))&&hu(l,t,r&&l.meta.op!=="on",g,s)}}for(u=Qu(e);l=u.pop();)Lw(l,e),r&&l.family.type==="crosslink"&&hu(l,t,l.meta.op!=="on",g,s)},Zc=e=>e.clear(),Du=(e,{deep:t}={})=>{let r=0;if(e.ownerSet&&e.ownerSet.delete(e),Jx(e)){r=1;const i=e.history;Zc(i.events),Zc(i.effects),Zc(i.stores),Zc(i.domains)}hu(bn(e),!!t,r,null,0)},F5=e=>Hp(()=>Du(e)),ai=(e,t,r,i,s)=>Ir({node:r,parent:e,child:t,scope:{fn:s},meta:{op:i},family:{owners:[e,t],links:t},regional:1}),o2=(e,t)=>(Tt(Br(t),".watch argument should be a function"),F5(Ir({scope:{fn:t},node:[Qm({fn:Zu})],parent:e,meta:{op:"watch"},family:{owners:e},regional:1}))),G5=(e,t,r="event")=>{al(e)&&al(e).hooks[r](t)},s2=(e,t)=>zr(e,"unitTrace",t),Ku=e=>{const t=Error("unit trace");return Error.captureStackTrace&&Error.captureStackTrace(t,e),t.stack},l2=(e,t,r,i)=>{const s=sl(r),l=e==="domain",u=D5(),{sid:d=null,named:h=null,domain:p=null,parent:y=p}=s,g=h||s.name||(l?"":u),b=E5(g,y),w={op:t.kind=e,name:t.shortName=g,sid:t.sid=$5(d),named:h,unitId:t.id=u,serialize:s.serialize,derived:s.derived,config:s,unitTrace:i};return t.targetable=!s.derived,t.parent=y,t.compositeName=b,t.defaultConfig=s,t.getType=()=>(il(0,"getType","compositeName.fullName"),b.fullName),!l&&(t.subscribe=S=>(n2(S),t.watch(Br(S)?S:T=>S.next&&S.next(T))),t[O5]=()=>t),w},Wh=(e,t,r,i)=>{let s;dr(r)&&(s=r,r=r.fn);const l=qe({name:`${e.shortName} → *`,derived:1,and:s});return ai(e,l,i,t,r),l},pu="undefined is used to skip updates. To allow undefined as a value provide explicit { skipVoid: false } option",c2=(e,t,r,i,s)=>{const l=lr(t),u=Rn({store:l,to:"a",priority:"read"});r===yo&&(u.data.softRead=1);const d=[u,Dr(i)];Qn("storeOnMap",l,d,Un(e)&&lr(e));const h=ai(e,t,d,r,s);return r!==yo&&zr(h,"onTrigger",bn(e).id),h},V5=(e,t,r,i,s,l,u)=>{const d=ui("combine",s),h=e?M=>[...M]:M=>({...M}),p=e?[]:{},y=h(p),g=wo(y),b=wo(1);g.type=e?"list":"shape",g.noInit=1,Qn("combineBase",g,b);const w=kt(y,{name:k5(r),derived:1,...u,and:s});s2(w,i);const S=lr(w);S.noInit=1,zr(w,"isCombine",1),zu(w,[Ir({meta:{stateRef:g}})]);const T=Ja(g);T.order={priority:"barrier"};const k=Rn({store:S,to:"b",priority:"read"});k.data.softRead=1;const _=[bo((M,O,L)=>(L.scope&&!L.scope.reg[g.id]&&(L.c=1),M)),T,Rn({store:b,to:"b"}),bo((M,{key:O},L)=>{if(L.c||M!==L.a[O])return t&&L.b&&(L.a=h(L.a)),L.a[O]=M,1},1),Rn({from:"a",target:g}),Rn({from:"value",store:0,target:b}),Rn({from:"value",store:1,target:b,priority:"barrier",batch:1}),Ja(g,1,1),l&&Dr(),k];if(Vu(r,(M,O)=>{if(!Un(M))return Tt(!Ta(M)&&!Dn(M),`combine expects a store in a field ${O}`,d),void(y[O]=p[O]=M);p[O]=M.defaultState,y[O]=M.getState();const L=ai(M,w,_,"combine",l);L.scope.key=O;const j=lr(M);qp(g,{type:"field",field:O,from:j}),Qn("combineField",j,L)}),w.defaultShape=r,zr(w,"defaultShape",r),qp(S,{type:yo,from:g,fn:l}),l){const M=l(y);!Dn(M)||u&&"skipVoid"in u||console.error(`${d}: ${pu}`),S.current=M,S.initial=M,w.defaultState=M}else w.defaultState=p;return w};Ir({node:[Qm({fn:({fn:e,value:t})=>e(t)})],meta:{op:"fx",fx:"sidechain"}});const Q5=["source","clock","target"],u2=(e,t)=>e+`: ${t} should be defined`,W5=(e,t,r,i,s,l,u,d,h,p,y,g)=>{const b=ui(e,d),w=!!s;Tt(!Dn(r)||!Dn(t),u2(b,"either source or clock"));let S=0;Dn(r)?S=1:Ta(r)||(r=Lr(r)),Dn(t)?t=r:(Ip(t,b,"clock"),Array.isArray(t)&&(t=ai(t,[],[],e))),S&&(r=t),d||u?d&&u?d.name=u:!d&&u&&(d={name:u}):u=r.shortName;let T="none";i&&(Ta(i)?T="unit":(Tt(Br(i),"`filter` should be function or unit"),T="fn")),s?(Ip(s,b,"target"),H5(b,s)):T==="none"&&p&&Un(r)&&Un(t)?s=kt(l?l(Xs(lr(r)),Xs(lr(t))):Xs(lr(r)),{name:u,sid:g,or:d}):(s=qe({name:u,derived:1,or:d}),Qn("sampleTarget",bn(s)));const k=wo();let _=[];const M=[];if(T==="unit"){const[j,X,G,ee]=Hw(i,s,t,k,e);ee&&zn(M,ee),G||_.push(...Zh(X)),_.push(...Zh(j))}const O=[];if(S)h&&zn(O,Ja(k,1,1));else{const[j,X,G,ee]=Hw(r,s,t,k,e);ee&&zn(M,ee),G||O.push(...Zh(X)),zn(O,Ja(j,1,h))}const L=ai(t,s,[Qn(),Rn({from:"stack",target:k}),...O,..._,Ja(k),T==="fn"&&Dr((j,X,{a:G})=>i(j,G),1),l&&Dr(r2),Qn("sampleSourceUpward",w)],e,l);return zu(r,[L]),zu(L,M),Object.assign(L.meta,d,{joint:1,stateRef:k}),s2(L,Ku(vl)),s},Zh=e=>[Ja(e),bo((t,r,{a:i})=>i,1)],Hw=(e,t,r,i,s)=>{const l=Un(e),u=l?lr(e):wo(),d=wo(l);let h;return l||(h=Ir({parent:e,node:[Rn({from:"stack",target:u}),Rn({from:"value",store:1,target:d})],family:{owners:[...new Set([e,t,r].flat())],links:t},meta:{op:s},regional:1})),Qn("sampleSource",d,u,i),[u,d,l,h]};var Kh={exports:{}},Jh={};/**
 * @license React
