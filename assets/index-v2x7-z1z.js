 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const $T="0.3.18",pm=`bippy-${$T}`,db=Object.defineProperty,HT=Object.prototype.hasOwnProperty,js=()=>{},S1=e=>{try{Function.prototype.toString.call(e).indexOf("^_^")>-1&&setTimeout(()=>{throw new Error("React is running in production mode, but dead code elimination has not been applied. Read how to correctly configure React for production: https://reactjs.org/link/perf-use-production-build")})}catch{}},T1=(e=ti())=>"getFiberRoots"in e;let k1=!1,Uc;const hp=(e=ti())=>k1?!0:(typeof e.inject=="function"&&(Uc=e.inject.toString()),!!(Uc!=null&&Uc.includes("(injected)"))),nu=new Set,pp=new Set,IT=e=>{const t=new Map;let r=0,i={checkDCE:S1,supportsFiber:!0,supportsFlight:!0,hasUnsupportedRendererAttached:!1,renderers:t,onCommitFiberRoot:js,onCommitFiberUnmount:js,onPostCommitFiberRoot:js,on:js,inject(s){const l=++r;return t.set(l,s),pp.add(s),i._instrumentationIsActive||(i._instrumentationIsActive=!0,nu.forEach(u=>u())),l},_instrumentationSource:pm,_instrumentationIsActive:!1};try{db(globalThis,"__REACT_DEVTOOLS_GLOBAL_HOOK__",{get(){return i},set(u){if(u&&typeof u=="object"){const d=i.renderers;i=u,d.size>0&&(d.forEach((h,p)=>{pp.add(h),u.renderers.set(p,h)}),mp(e))}},configurable:!0,enumerable:!0});const s=window.hasOwnProperty;let l=!1;db(window,"hasOwnProperty",{value:function(){try{if(!l&&arguments[0]==="__REACT_DEVTOOLS_GLOBAL_HOOK__")return globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__=void 0,l=!0,-0}catch{}return s.apply(this,arguments)},configurable:!0,writable:!0})}catch{mp(e)}return i},mp=e=>{e&&nu.add(e);try{const t=globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!t)return;if(!t._instrumentationSource){if(t.checkDCE=S1,t.supportsFiber=!0,t.supportsFlight=!0,t.hasUnsupportedRendererAttached=!1,t._instrumentationSource=pm,t._instrumentationIsActive=!1,t.on=js,t.renderers.size){t._instrumentationIsActive=!0,nu.forEach(i=>i());return}const r=t.inject;hp(t)&&!T1()&&(k1=!0,t.inject({scheduleRefresh(){}})&&(t._instrumentationIsActive=!0)),t.inject=i=>{const s=r(i);return pp.add(i),t._instrumentationIsActive=!0,nu.forEach(l=>l()),s}}(t.renderers.size||t._instrumentationIsActive||hp())&&(e==null||e())}catch{}},qT=()=>HT.call(globalThis,"__REACT_DEVTOOLS_GLOBAL_HOOK__"),ti=e=>qT()?(mp(e),globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__):IT(e),BT=()=>{var e,t;return!!(typeof window<"u"&&((e=window.document)!=null&&e.createElement||((t=window.navigator)==null?void 0:t.product)==="ReactNative"))},YT=()=>{try{BT()&&ti()}catch{}};/**
 * @license bippy
 *
 * Copyright (c) Aiden Bai
 *
