...
- [ ] тест на переход раундов в `backend/server.ts`: логика сидит внутри DB-связанного `endTurn`, надо вынести чистую функцию «кто следующий / закончилась ли игра». Там уже был off-by-one
