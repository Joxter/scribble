...
- [ ] создавать рисунок при выборе слова (слово, автор, количество отгадываний merge, статус in-progress/done)
  - [ ] записывать ссылку на рисунок в игровое состояние currentDraw
  - [ ] тот кто рисует, транслирует рисунок через топик, но каждую нарисованную линию записывает в рисунок через транзакцию
  - [ ] игроки при открытии страницы единоразово качают рисунок из базы
  - [ ] отгадки записываются в рисунок игроками самостоятельно
  - [ ] СЕРВЕР подписывается на обновления рисунков 
    - [ ] и если есть все отгадки, то завершает ход и отправляет сообщение в чат
- [ ] сообщения в чат
