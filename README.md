...
- [ ] перепроверить список игроков
  - перейти на правильный локальный id
  - игроки видят список игр в которых
  - в игру записываются слепок игроков включая (id, имя и остальное)
  - добавить кнопку выхода из игры/кика, тогда софтделит из снапшота игроков
  - как-то связать локальный ID со снапшотом
- [ ] мелкий рефакторинг
  - [ ] сторы для всех рисунков
