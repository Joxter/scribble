...
- [ ] доделать оценку рисунка: миниатюра и реакции в окне выбора слова сейчас плейсхолдер
...
- [ ] почистить словарь `dictionaries/ru-300-chatgpt.ts`: 300 записей, но только 203 уникальных (97 дубликатов). Код к этому устойчив, но слов по факту меньше, чем кажется
