...
- [ ] алгоритм подсчета очков
  - [ ] очки за отгадку (по скорости) + очки рисовальщику
  - [ ] показывать очки в списке игроков
- [ ] финал: можно создать ещё одну игру (с теми же игроками)
- [ ] UI: "игра не найдена" для несуществующей/закрытой комнаты
- [ ] UI: крупно показывать текущего рисующего и следующего, остальных — кратко
...
- [ ] можно проголосовать за рисунок в окне выбора слова
